# Phase Log — Archive (Phase 12 → ~96, Batch-First → Mockup Studio early)

> **ARCHIVE — HISTORICAL ONLY, NOT AUTHORITATIVE.**
>
> Bu dosya `CLAUDE.md`'den çıkarılmış tarihsel phase anlatısıdır
> (Batch-First Phase 1'den Mockup Studio Phase ~96'ya). **Güncel
> davranış / canonical invariant buradan OKUNMAZ.** Bir Claude
> ajanı bu dosyayı authoritative kaynak sanmamalıdır.
>
