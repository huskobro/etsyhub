      ...
      <header className="flex h-16 flex-shrink-0 items-center gap-4 border-b border-line bg-bg pl-6 pr-5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline gap-3">
            ...
            {/* Batch-first Phase 5 — pipeline identity chip (ürün dili).
             * "MJ" / "AI" altyapı jargonu değil; operatör için
             * "Auto-batch" (AI variation pipeline) vs "Manual batch"
             * (MJ bridge — operatör browser üzerinden üretti) ayrımı.
             * Audit/debug için data-pipeline attribute korunur. */}
            <span
              ...
              title={
                summary.pipeline === "ai-variation"
                  ? "Auto-batch — generated by AI variation provider"
                  : "Manual batch — Midjourney bridge"
              }
            >
